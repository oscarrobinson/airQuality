<div class="canvas1"></div>
		...
		// canvas
		var canvas = d3.select('.canvas1').append('svg')
		    .attr('width', width)
		    .attr('height', height);
		...
		d3.json("data/airData.json", function(data) {
			...
			console.log(data["BRI"]["Spring"]["Monday"][5].value);
			...
			var arc = d3.svg.arc()
				...
				.outerRadius(function (d, i) {
					return 20 + data["BRI"]["Spring"]["Monday"][i].value/3;
				});
			...
			arcs.append('text')
			    ...
			    .text(function (d) {
			    	...
			    	console.log("success");
			    	return data["BRI"]["Spring"]["Monday"][i].value;
				});
		});
